      ...
      <v-app :style="{background: $vuetify.theme.themes.dark.background}" class="rounded-tr-xl rounded-br-xl">
        <v-container>
          <v-row>
            ...
            <v-col cols="12" sm="6">
              <v-card class="mx-12 rounded-tl-xl rounded-tr-xl rounded-bl-xl rounded-br-xl mt-n4" color="teal">
                <v-list-item three-line>
            ...
            <v-col cols="12" sm="6">
              ...
              <v-progress-circular rotate="360" size="100" width="15" value="50" color="teal" class="mt-n5 ml-5 mb-2">50</v-progress-circular>
              <v-progress-circular rotate="360" size="100" width="15" value="70" color="red" class="mt-n5 ml-5 mb-2">70</v-progress-circular>
              <v-progress-circular rotate="360" size="100" width="15" value="80" color="blue" class="mt-n5 ml-5 mb-2">80</v-progress-circular>
              </v-card>
            </v-col>
          </v-row>
        </v-container>
            ...
            <v-col cols="12" sm="12">
              <v-list two-line>
                <v-list-item>
                  ...
                  <v-list-item-content>
                    <v-list-item-title>Anastatia Turner</v-list-item-title>
                    <v-list-item-subtitle class="teal--text">35 years, Houston
                    </v-list-item-subtitle>
                  </v-list-item-content>
                  <v-space></v-space>
